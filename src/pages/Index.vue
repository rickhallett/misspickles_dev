  ...
  data() {
    return {
      ...
      compressedStoreTableCols: [
        ...
        { name: 'morning', label: 'AM', field: 'morning', sortable: true, style: '', classes: '', headerStyle: '', headerClasses: '', },
        { name: 'afternoon', label: 'PM', field: 'afternoon', sortable: true, style: '', classes: '', headerStyle: '', headerClasses: '', },
  ...
  mounted() {
    ...
    let svg = d3.select("#my_dataviz")
      ...
      const circle = svg.selectAll('.ufoCircle') //select all elements with class ufoCircle. (There currently are none)
        ...
        .attr("cx", function(d) { return d.day; })
